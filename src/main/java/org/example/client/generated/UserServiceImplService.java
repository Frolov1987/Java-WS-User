 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://server.example.org/", wsdlLocation = "http://localhost:8087/ws/user?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8087/ws/user?wsdl");
